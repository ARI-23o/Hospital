      ...
      <section className="bg-gradient-to-r from-[#0F2D59] via-[#163D75] to-[#0D9488] text-white py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-3xl">
          ...
          <p className="text-xs sm:text-base text-slate-200 mt-2 font-normal leading-relaxed">
            Essential preparation checklists, OPD workflow guidelines, home care regimens, and
            insurance support.
          </p>
        </div>
      </section>
              ...
              <div className="space-y-5 animate-fadeIn">
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
                    A simple preparation checklist for your consultation with Dr. Sagar Sarda.
                  </p>
                </div>
            ...
            {activeSection === "during" && (
              <div className="space-y-5 animate-fadeIn">
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
                    What to expect throughout your clinical appointment.
                  </p>
                </div>

                <div className="space-y-3.5 text-xs sm:text-sm text-slate-600">
                  <div className="p-4 rounded-2xl bg-blue-50/60 border border-blue-100">
                    <h4 className="font-bold text-[#0F2D59] mb-1">
                      1. Initial Vitals & Clinical Triaging
                    </h4>
                    <p>
                      Our nurse measures your accurate resting blood pressure, pulse, body weight,
                      and oxygen saturation.
                    </p>
                  </div>
                  <div className="p-4 rounded-2xl bg-teal-50/60 border border-teal-100">
                    <h4 className="font-bold text-[#0F2D59] mb-1">
                      2. In-Depth Nephrology Consultation
                    </h4>
                    <p>
                      Dr. Sagar Sarda reviews your history, conducts physical examination (edema
                      check, cardiovascular), and analyzes lab trends.
                    </p>
                  </div>
                  <div className="p-4 rounded-2xl bg-emerald-50/60 border border-emerald-100">
                    <h4 className="font-bold text-[#0F2D59] mb-1">
                      3. Clear Treatment Plan & Diet Roadmap
                    </h4>
                    <p>
                      You will receive a step-by-step medication schedule, personalized dietary
                      potassium/sodium guidance, and scheduled follow-ups.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {activeSection === "after" && (
              <div className="space-y-5 animate-fadeIn">
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
                    Maintaining your kidney health regimen at home.
                  </p>
                </div>
            ...
            {activeSection === "insurance" && (
              <div className="space-y-5 animate-fadeIn">
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
                    Transparent and affordable pricing for kidney care and dialysis.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200">
                    <h4 className="font-bold text-[#0F2D59] text-xs sm:text-sm mb-1">
                      Cashless TPA & Mediclaim
                    </h4>
                    <p className="text-xs text-slate-500">
                      We assist patients with reimbursement documentation and cashless processing
                  ...
                  <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200">
                    ...
                    <p className="text-xs text-slate-500">
                      Guidance on state and national health coverage for eligible dialysis patients.
                    </p>
                  </div>
                </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="bg-sky-50 rounded-2xl p-4 sm:p-6 border border-sky-100 max-w-2xl mx-auto">
          ...
          <p className="text-[11px] sm:text-xs text-slate-500 mt-1">
            We encourage you and your family to ask questions and take an active role in managing
            your kidney wellness.
          </p>
        </div>
      </section>
    </div>
