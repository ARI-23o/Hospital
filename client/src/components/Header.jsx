...
import { Phone, MapPin, Clock, HeartPulse, UserCheck, Menu, X, Calendar, ChevronRight, Globe } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-2">
          ...
          <div className="flex items-center space-x-3 truncate">
            ...
            >
              ...
              <span className="truncate">{t('common.hospitalAddress', 'Behind LIC Office, Chandrapur, Maharashtra')}</span>
            </a>
            <span className="hidden md:inline text-slate-500">|</span>
            <span className="hidden md:flex items-center gap-1 text-slate-300">
              <Clock className="w-3 h-3 text-teal-400 shrink-0" /> {t('common.opdHours', 'Mon - Sat: 9:00 AM - 7:00 PM')}
            </span>
          </div>
