  ...
  const screens = [
    {
      ...
      highlights: [
        'Hero: "Expert Care for Healthier Kidneys"',
        "Nephrology 4-pillar overview",
        "Maharashtra community banner",
        "Direct OPD booking button",
      ],
    },
    {
      number: "2",
      ...
      highlights: [
        "Doctor-led non-transplant kidney clinic",
        "Patient-first ethical care ethos",
        "Modern clinical timeline",
    ...
    },
    {
      ...
      highlights: [
        "CKD Stages 1-5 management",
        "High-flux dialysis supervision",
        "Renal hypertension protocols",
        "Kidney stone & UTI treatments",
      ],
    },
    {
      number: "4",
      ...
      highlights: [
        "MD & DM Nephrology credentials",
        "Consultant Nephrologist badge",
        "Areas of expertise summary",
        "Compassionate personal quote",
      ],
    },
    {
      number: "5",
      ...
      highlights: [
        "Pre-visit medical checklist",
        "In-clinic consultation process",
        "Mediclaim & Cashless TPA info",
        "Nephrology FAQ accordion",
      ],
    },
    {
      number: "6",
      ...
      highlights: [
        "Modern high-flux dialysis unit",
    ...
    },
    {
      ...
      highlights: [
        "Behind LIC Office, Chandrapura",
        "OPD helpline: +91 98765 43210",
    ...
    },
    {
      ...
      highlights: [
        ...
        "Reason for consultation choice",
        "Instant booking reference number",
          ...
          {screens.map((screen) => (
            ...
            >
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1 mb-4 leading-relaxed">{screen.tagline}</p>
